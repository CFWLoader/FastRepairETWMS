                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" name="toolloginfo" action="expensivetoollog.jsp" method="post">
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <select name="status" class="form-control" <%=expensiveToolLog.getStatus().equals("Waiting for deal") || expensiveToolLog.getStatus().equals("Back") ? "disabled=\"disabled\"" : ""%>>
                                ...
                                <%=expensiveToolLog.getStatus().equals("Waiting for deal") || expensiveToolLog.getStatus().equals("Back")? "<input type=\"hidden\" name=\"status\" value=\"" + expensiveToolLog.getStatus() + "\" />" : ""%>
                            </div>
                            <div class="form-group">
