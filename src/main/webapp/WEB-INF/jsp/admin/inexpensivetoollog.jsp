...
<%
    ...
    if(action != null && action.trim().equals("buildlog")){
        ...
        inexpensiveToolLog.setStatus("Confirming");
                    ...
                    <div class="tab-pane active in" id="home">
                        <form id="tab" name="toolloginfo" action="inexpensivetoollog.jsp" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<%=employee.getFirstName() + " " + employee.getLastName()%>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Tool Name</label>
                                <input type="hidden" name="toolid" value="<%=tool.getId()%>"/>
                                <input type="text" value="<%=tool.getToolName()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Quantity</label>
                                <input type="text" name="quantity" value="<%=inexpensiveToolLog.getQuantity()%>" class="form-control">
                            </div>
                            <!--
                            <div class="form-group">
                                <label>Status</label>
