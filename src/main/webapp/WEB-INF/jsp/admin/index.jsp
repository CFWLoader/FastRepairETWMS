    ...
    <ul>
        ...
        <li>
            <ul class="dashboard-menu nav nav-list collapse in">
                <li><a href="<%=AppContext.getBaseUrl()%>/admin/index"><span class="fa fa-caret-right"></span> Main</a></li>
            </ul>
        </li>
        ...
        <li>
            <ul class="tool-menu nav nav-list collapse">
                ...
                <li><a href="<%=AppContext.getBaseUrl()%>/admin/inexpensivetoollogs?pageIndex=0&pageSize=10"><span class="fa fa-caret-right"></span> Inexpensive tool logs</a>
                </li>
                <li><a href="<%=AppContext.getBaseUrl()%>/admin/expensivetoollogs?pageIndex=0&pageSize=10"><span class="fa fa-caret-right"></span> Expensive tool logs</a></li>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="knob-container">
                        <input class="knob" data-width="200" data-min="0" data-max="3000" data-displayPrevious="true"
                               value="2500" data-fgColor="#92A3C2" data-readOnly=true;>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="knob-container">
                        <input class="knob" data-width="200" data-min="0" data-max="4500" data-displayPrevious="true"
                               value="3299" data-fgColor="#92A3C2" data-readOnly=true;>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="knob-container">
                        <input class="knob" data-width="200" data-min="0" data-max="2700" data-displayPrevious="true"
                               value="1840" data-fgColor="#92A3C2" data-readOnly=true;>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="knob-container">
                        <input class="knob" data-width="200" data-min="0" data-max="15000" data-displayPrevious="true"
                               value="10067" data-fgColor="#92A3C2" data-readOnly=true;>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="panel panel-default">
                ...
                <div id="widget1container" class="panel-body collapse in">
                    ...
                    <p>This template was developed with <a href="http://middlemanapp.com/" target="_blank">Middleman</a>
                        and includes .erb layouts and views.</p>
