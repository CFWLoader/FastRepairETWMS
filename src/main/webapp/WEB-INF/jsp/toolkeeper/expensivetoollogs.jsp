...
<%@ page import="pers.evan.fastrepair.model.ExpensiveToolLog" %>
...
<%
    ...
    String targetId = request.getParameter("employeeid");

    if(targetId != null && !targetId.trim().equals(""))id = Integer.parseInt(targetId);
    ...
    int totalRecords = toolLogService.getTotalOfInexpensiveToolLogByEmployeeId(id);
    ...
    */
    ...
    List<ExpensiveToolLog> expensiveToolLogs = toolLogService.getExpensiveTooLogsByEmployeeId(id, pageNo, PAGE_SIZE);
...
<div class="content">
    ...
    <div class="main-content">
            ...
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" name="toolloginfo" action="expensivetoollogs.jsp" method="post">

                            <div class="form-group">
                                <label>Employee Id</label>
                                <input type="text" name="employeeid" value="0" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Status</label>
                                <select name="status" class="form-control">
                                    <option value="Waiting for deal" selected="selected">Waiting for deal
                                    </option>
                                    <option value="Lent">Lent
                                    </option>
                ...
                <div class="btn-toolbar list-toolbar">
                    <button class="btn btn-primary" onclick="submitForm(document.forms['toolloginfo'])"><i class="fa fa-search"></i> Search</button>
                </div>
            </div>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
            <%
                for (ExpensiveToolLog expensiveToolLog : expensiveToolLogs) {
            %>
            <tr>
                <td><%=expensiveToolLog.getId()%>
                </td>
                <td><%=expensiveToolLog.getEmployeeId()%>
                </td>
                <td><%=expensiveToolLog.getToolId()%>
                </td>
                <td><%=expensiveToolLog.getQuantity()%>
                </td>
                <td><%=expensiveToolLog.getStatus()%>
                </td>
                <td><%=expensiveToolLog.getLendDate()%>
                </td>
                <td><%=expensiveToolLog.getBackDate()%>
                </td>
                <td>
                    <a href="expensivetoollog.jsp?action=peek&id=<%=expensiveToolLog.getId()%>"><i class="fa fa-pencil"></i></a>
        ...
        <ul class="pagination">
            ...
            %>
            <li><a href="tools.jsp?employeeid=<%=id%>&pageNo=<%=i%>"><%=i%>
            </a></li>
            <%
                }
            %>
