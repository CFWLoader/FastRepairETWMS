...
<%
    ...
    if (action != null && action.trim().equals("modifyemployee")) {

        Employee modifyingEmployee = employeeService.employeeObjectAssembler(idStr,
...
<div class="content">
    <div class="header">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><%=employee.getFirstName() + " " + employee.getLastName()%>
            </li>
        </ul>
                    ...
                    <div class="tab-pane active in" id="home">
                        <form id="tab" name="employeeinfo" action="employee.jsp" method="post">
                            ...
                            <input type="hidden" name="action"
                                   value="<%=employee.getId() > 0? "modifyemployee" : "addemployee"%>"/>
                            ...
                            <div class="form-group">
                                <label>Gender</label>
                                <input type="text" name="gender" value="<%=employee.getGender()%>"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Phone</label>
