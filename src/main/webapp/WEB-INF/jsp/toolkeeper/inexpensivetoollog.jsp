...
<%@ page import="pers.evan.fastrepair.service.*" %>
<%@ page import="pers.evan.fastrepair.service.impl.*" %>
...
<%
    ...
    toolBorrower = employeeService.getEmployeeById(String.valueOf(inexpensiveToolLog.getEmployeeId()));
