    ...
    <div class="main-content">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><%=tool.getNumberOfAvailable()%></td>
                <td><%=tool.getCompany().getCompanyName()%></td>
                <td><%=tool.getDepartment().getDepartmentType()%></td>
                <td>
                    <a href="tool.jsp?id=<%=tool.getId()%>"><i class="fa fa-pencil"></i></a>
        ...
        <ul class="pagination">
            ...
            %>
            <li><a href="tools.jsp?pageNo=<%=i%>"><%=i%></a></li>
            <%
                }
            %>
