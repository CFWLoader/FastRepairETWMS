...
<%
    ...
    Tool tool = toolService.getToolById(idStr);
...
<div class="content">
    <div class="header">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><%=tool.getToolType()%>
            </li>
        </ul>
                    ...
                    <div class="tab-pane active in" id="home">
                        <form id="tab">
                            <div class="form-group">
                                <label>Tool ID</label>
                                <input type="text" value="<%=tool.getId()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tool Type</label>
                                <input type="text" value="<%=tool.getToolType()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Number of available</label>
                                <input type="text" value="<%=tool.getNumberOfAvailable()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Company</label>
                                <input type="text" value="<%=tool.getCompany().getCompanyName()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Company location</label>
                                <input type="text" value="<%=tool.getCompany().getLocation()%>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Department</label>
                                <input type="text" value="<%=tool.getDepartment().getDepartmentType()%>" class="form-control">
                            </div>
