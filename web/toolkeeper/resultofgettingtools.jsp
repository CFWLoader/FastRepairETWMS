...
<%@ page import="team.unnamed.fastrepair.exception.BadUpdateQueryException" %>
<%@ page import="team.unnamed.fastrepair.exception.UserNotFoundException" %>
  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="index.jsp"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> Fast Repair</span></a></div>
        ...
        <div class="panel-body">
            <form method="post">
                ...
                <div class="form-group">
                    <label><%= result > 0.1 ? "Please get tools at line " + line + "." : "System failed.Please notify the adminstrator."%></label>
                </div>
                <a href="index.jsp"><input type="button" value="Back to logs." class="btn btn-primary pull-right"/></a>
